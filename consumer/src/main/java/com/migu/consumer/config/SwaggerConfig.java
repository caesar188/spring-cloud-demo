...
public class SwaggerConfig
{
  ...
  ApiInfo apiInfo()
  {
    return new ApiInfoBuilder().title("swagger demo API").description("demo").termsOfServiceUrl("").version("1.0.0")
  ...
  public Docket customImplementation()
  {
    return new Docket(DocumentationType.SWAGGER_2).select()
        .apis(RequestHandlerSelectors.basePackage("com.migu.consumer.controller"))
